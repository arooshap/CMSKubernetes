...
# NOTE: we separated workqueue, reqmon, acdcserver and couchdb into individual
...
sed -i -e "s#ServerMonitor/2.0#ServerMonitor-acdcserver#g" /data/srv/current/config/admin/ServerMonitor
